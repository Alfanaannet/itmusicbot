  ...
  run: async (client, message, args) => {
    ...
    if (type === "enable") {
      if (user.isBanned === true) {
        ...
        const embed = new EmbedBuilder().setDescription(` :ballot_box_with_check: | You've successfully banned \`${id}\`.`).setColor(client.color);
      ...
      if (user.isBanned === false) {
        ...
        const embed = new EmbedBuilder().setDescription(`:ballot_box_with_check:  | You've successfully unbanned \`${id}\`.`).setColor(client.color);
