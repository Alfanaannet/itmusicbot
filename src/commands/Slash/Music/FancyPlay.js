...
module.exports = {
    ...
    run: async (client, interaction) => {
        ...
        if (loadType === "PLAYLIST_LOADED") {
            ...
            const embed = new EmbedBuilder()
                .setColor(client.color)
                .setDescription(` :ballot_box_with_check:  | **[${playlistInfo.name}](${song})** • \`${tracks.length}\` tracks • ${track.info.requester}`);
            ...
            const embed = new EmbedBuilder()
                .setColor(client.color)
                .setDescription(
                    `:ballot_box_with_check: | **[${track.info.title ? track.info.title : "Unknown"}](${track.info.uri})** • \`${
