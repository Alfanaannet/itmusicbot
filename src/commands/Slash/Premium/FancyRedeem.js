    ...
    run: async (client, interaction) => {
        ...
        if (code) {
            ...
            const embed = new EmbedBuilder()
                ...
                .setDescription(`Conratulations :two_hearts: ${interaction.member}. You've successfully redeem premium code with the following details.`)
            ...
            if (user.premium.plan === "lifetime") {
                embed.addFields([
                    { name: `:dizzy: | Redeemed By`, value: `\`\`\`${interaction.member.displayName}\`\`\``, inline: true },
                    { name: `<:star:1059809101321871471> | Plan Type`, value: `\`\`\`${user.premium.plan}\`\`\``, inline: true },
                    { name: `:clock12: | Expired Time`, value: `\`\`\`Never\`\`\``, inline: false },
                ]);
            } else {
                embed.addFields([
                    { name: `:dizzy: | Redeemed By`, value: `\`\`\`${interaction.member.displayName}\`\`\``, inline: true },
                    { name: `<:star:1059809101321871471> | Plan Type`, value: `\`\`\`${user.premium.plan}\`\`\``, inline: true },
                    { name: `:clock12: | Expired Time`, value: `\`\`\`${expires}\`\`\``, inline: false },
                ]);
            }
